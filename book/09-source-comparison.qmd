...
comp["gdacs_state"] = comp["storm_id"].map(gdacs_state)
STATE = comp.set_index("storm_id")["gdacs_state"]
```
...
miss = comp[comp.gdacs_state == "missing"].storm_id
chd_tot = (panel0[(panel0.storm_id.isin(miss)) & (panel0.wind_speed_kt == 34)]
           .groupby("storm_id").agg(name=("storm_name", "first"),
...
chdpos["gstate"] = chdpos.storm_id.map(STATE)
...
comp0 = set(zip(ov0.storm_id, ov0.iso3, ov0.wind_speed_kt))
inc0 = [(s, i, k) in comp0 for s, i, k in
        zip(ov1.storm_id, ov1.iso3, ov1.wind_speed_kt)]

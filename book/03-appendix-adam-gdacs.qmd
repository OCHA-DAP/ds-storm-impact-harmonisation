---
title: "Technical Appendix: ADAM & GDACS Exploration"
jupyter: ds-storm-impact
---

ADAM (WFP) and GDACS were the original candidate exposure datasets for this
analysis. However, both proved unusable due to limited temporal overlap with
CERF allocations (2006–2023). This appendix documents the exploration and
findings for completeness. The main analysis uses the OCHA exposure dataset

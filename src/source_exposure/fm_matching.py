...
Vendoring: this file is self-contained (pandas + sqlalchemy.text). Copy it into
ds-storms-alerts/src/ and call match_gdacs / match_adam on the rows that repo's
advisory-window fetchers return.
"""

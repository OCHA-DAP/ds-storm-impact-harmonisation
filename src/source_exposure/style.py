"""Excel styling for the storm-exposure workbook — matches the repo's Quarto
book theme (OCHA green #55b284, cosmo-style headers).

Two public helpers:
  style_data_sheet(ws, ...)  — green header, frozen top row, auto-filter,
                               number formats, column widths.
  build_readme(ws, blocks)   — a styled "README" cover sheet from a list
                               of (kind, text) blocks.
"""
